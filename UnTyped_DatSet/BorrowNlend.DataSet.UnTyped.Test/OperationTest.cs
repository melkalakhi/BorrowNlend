...
using BorrowNlend.DataSet.DAO;
using BorrowNlend.DataSet.DTO;

namespace BorrowNlend.DataSet.Test.UnTyped
{
    public class OperationTest
    {
            ...
            string Name2, string Address2, string Email2, double Amount2, OperationType Type2)
        {
            ...
            IList<OperationDTO> operationDTOs = OperationDAO.Instance.GetAll();
            ...
            personDTO = PersonDAO.Instance.Add(personDTO);
            ...
            operationDTO = OperationDAO.Instance.Add(operationDTO);
            ...
            operationDTO = operationDTOs[count1];
            ...
            Assert.Throws<InvalidConstraintException>(delegate() { PersonDAO.Instance.Delete(personDTO); });
            Assert.Throws<InvalidConstraintException>(() => PersonDAO.Instance.Delete(personDTO));
